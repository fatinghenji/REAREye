...
val fallbackGitBranch = runGitCommand("branch", "--show-current") ?: "unknown"
        ...
        if (!file.exists() || isFallback) {
            ...
            file.writeText(
                ...
                public object AppProperties {
                    ...
                    public const val BUILD_NUMBER: Int = $gitVersionCode
                    public const val BUILD_CHANNEL: String = "$buildSuffix"
                    public const val IS_PUBLIC_BETA: Boolean = $isPublicBetaBuild
                    public const val PROJECT_APP_VERSION_NAME: String = "$baseVersionName"
                    public const val PROJECT_APP_VERSION_CODENAME: String = "EyeOfLazarus"
                }
                """.trimIndent()
            )
        }
